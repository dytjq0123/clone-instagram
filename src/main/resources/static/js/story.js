        ...
        <article>
            <header>
                <div class="profile-of-article">
                    ...
                    <img class="img-profile pic" src="/profileImgFiles/${post.user.profileImgUrl}" onerror="this.src='/img/default_profile.png'"></a>
            ...
            <div class="reaction">
                ...
                post.commentList.forEach((comment)=>{
                    item += `<li id="storyCommentItem-${comment.id}">
                                ...
                                if(parseInt(principalId.value) == comment.user.id) {
